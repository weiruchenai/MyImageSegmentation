...
dir_img = './data/polyp/augment/imgs/'
# dir_img = './data/cars/imgs/'
dir_mask = './data/polyp/augment/masks/'
# dir_mask = './data/cars/masks/'
dir_checkpoint = 'checkpoints_polyp/'
...
def get_args():
    ...
    parser.add_argument('-e', '--epochs', metavar='E', type=str, default=5,
