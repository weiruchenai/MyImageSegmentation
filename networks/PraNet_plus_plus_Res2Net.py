...
class PraNet_plus_plus(nn.Module):
    # res2net based encoder decoder
    def __init__(self, n_channels=3, n_classes=1, bilinear=False, channel=32):
        super(PraNet_plus_plus, self).__init__()
        ...
        self.squeeze_excite0 = DSqueeze_Excite_Block(64)
        ...
        self.aspp_bridge = MASPP(32, 32)  # x4_rfb=[4,32,4,6],channel数为32
        # ---- Partial Decoder ----
